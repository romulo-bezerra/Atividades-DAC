...
import com.ifpb.appbanco.infra.ClientesEmMemoria;
import com.ifpb.appbanco.infra.ClientesJDBC;
...
public class Controlador extends HttpServlet {
    ...
    private void imprimirTodosOsClientes(final PrintWriter out){
        for(Cliente cl : clientes.todosOsClientes()) {
            out.println(cl.getNome());
        }
    }
